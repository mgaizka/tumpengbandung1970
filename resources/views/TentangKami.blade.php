        ...
        <div class="text-white py-12">
            ...
            <div class="px-4 sm:px-8 md:px-16 text-white pt-10">
                ...
                <p class="text-gray-300 text-base sm:text-lg md:text-xl leading-relaxed mb-6 text-justify">
                    Perjalanan usaha ini bermula pada tahun 1970, ketika Ibu Hj. Nunung Juaeriah mendirikan sebuah warung makan sederhana
                    bernama Lotek Tjihapit 1970 di Jl. Cihapit No. 8A, Bandung. Dengan modal semangat dan keterampilan memasak yang
                    diwariskan turun-temurun, warung kecil tersebut hadir untuk memenuhi kebutuhan makan masyarakat sekitar dengan sajian
                    khas Sunda, khususnya lotek dan rujak yang diracik dengan bumbu kacang buatan sendiri.
                </p>
                <p class="text-gray-300 text-base sm:text-lg md:text-xl leading-relaxed mb-6 text-justify">
                    Pada masa-masa awal, Lotek Tjihapit 1970 hanya melayani kebutuhan makan harian pelanggan sekitar serta pesanan rantang
                    keluarga. Namun, berkat cita rasa yang khas, kesegaran bahan, serta konsistensi dalam menjaga kualitas, warung ini
                    perlahan mulai dikenal lebih luas. Banyak pelanggan yang kemudian menjadikan Lotek Tjihapit 1970 sebagai destinasi wajib ketika
                    berkunjung ke kawasan Cihapit. Nama Lotek Tjihapit 1970 pun semakin melekat di hati masyarakat Bandung sebagai salah
                    satu ikon kuliner tradisional Sunda.
                </p>
                <p class="text-gray-300 text-base sm:text-lg md:text-xl leading-relaxed mb-6 text-justify">
                    Seiring berjalannya waktu dan meningkatnya permintaan, usaha ini tidak lagi hanya sebatas warung makan keluarga. Pada
                    tahun 2015, usaha keluarga tersebut resmi dikembangkan menjadi badan usaha berbentuk CV dengan nama CV Tjihapit 8A, yang
                    dipimpin oleh Ibu Lenggawati. Transformasi ini menandai langkah besar dalam pengelolaan usaha, karena dari sini lahirlah
                    “Tjihapit Catering” sebagai branding utama perusahaan
                </p>

                <p class="text-gray-300 text-base sm:text-lg md:text-xl leading-relaxed mb-6 text-justify">
                Di bawah Tjihapit Catering, terdapat dua unit usaha yang berjalan secara beriringan: 1. Lotek Tjihapit 1970, yang tetap
                mempertahankan keaslian konsep warung makan Sunda dengan menu khas seperti lotek, rujak, dan aneka masakan Sunda. 2.
                Tumpeng Bandung 1970, yang dikembangkan untuk menjawab kebutuhan pasar akan layanan katering profesional, meliputi
                tumpeng, tumpeng mini, nasi box, nasi besek, bento, nasi liwet, hingga paket catering acara lainnya.
                </p>
                <p class="text-gray-300 text-base sm:text-lg md:text-xl leading-relaxed mb-6 text-justify">
                    Dengan hadirnya Tumpeng Bandung 1970, cakupan layanan pun semakin luas. Tidak hanya melayani kebutuhan rumah tangga,
                    tetapi juga dipercaya untuk menyediakan hidangan katering perkantoran, kampus, acara komunitas, hingga event berskala
                    besar dengan jumlah pesanan mencapai ribuan porsi per hari. Kepercayaan ini tumbuh berkat reputasi panjang yang dibangun
                    dari kualitas rasa, pelayanan yang ramah, serta penyajian hidangan yang rapi dan elegan
                </p>
                <p class="text-gray-300 text-base sm:text-lg md:text-xl leading-relaxed mb-6 text-justify">
                    Kini, setelah lebih dari lima dekade perjalanan, CV Tjihapit 8A terus berkembang sebagai perusahaan kuliner yang
                    menggabungkan tradisi dengan inovasi. Dengan manajemen yang solid, pengalaman yang matang, dan semangat untuk selalu
                    beradaptasi dengan kebutuhan zaman, Tjihapit Catering berkomitmen menghadirkan layanan katering berkualitas dengan cita
                    rasa autentik, higienis, dan dekorasi yang sesuai dengan kebutuhan setiap klien
                </p>
                <p class="text-gray-300 text-base sm:text-lg md:text-xl leading-relaxed mb-6 text-justify">
                    Tidak hanya sekadar menjual makanan, tetapi juga berusaha menciptakan pengalaman kuliner yang menghadirkan kebahagiaan,
            ...
            <div class="px-4 sm:px-8 md:px-16 pt-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 justify-items-center">
                    ...
                    <!-- Wrapper 5-6-7 biar center -->
                    <div class="lg:col-span-4 flex flex-wrap justify-center gap-8">
                        <!-- Step 5 -->
                        <div class="flex flex-col items-center text-center max-w-xs">
