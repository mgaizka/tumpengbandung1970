    ...
    <div id="default-carousel" class="relative w-full overflow-hidden" data-carousel="slide">
        ...
        <div class="relative h-56 sm:h-72 md:h-[500px] lg:h-screen">
            ...
            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                <img src="{{ asset('foto1.jpeg') }}" class="absolute inset-0 w-full h-full object-cover" alt="Foto 1">
            </div>
            <!-- Item 2 -->
            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                <img src="{{ asset('foto2.jpeg') }}" class="absolute inset-0 w-full h-full object-cover" alt="Foto 2">
            </div>
        </div>
        ...
        <div class="py-14 px-4 md:px-[1cm] lg:px-[2cm] text-white">
            ...
            <!-- Grid Card Produk -->
            <div data-aos="fade-up" class="grid gap-8 sm:grid-cols-2 lg:grid-cols-3 mx-auto">
                <!-- Tumpeng Premium -->
                <div data-aos="fade-up" class="rounded-lg overflow-hidden shadow-lg hover:scale-105 transform transition duration-300">
        ...
        <div class="py-14 pb-[50px] px-4 md:px-[1cm] lg:px-[2cm] text-center mt-[60px]">
            ...
            <!-- Grid Logo -->
            <div  data-aos="zoom-in" class="grid gap-10 sm:grid-cols-2 lg:grid-cols-4 mx-auto">
