    ...
    <div id="default-carousel" class="relative w-full" data-carousel="slide">
        ...
        <div class="relative h-56 sm:h-72 md:h-[500px] lg:h-screen overflow-hidden">
            ...
            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                <img src="{{ asset('foto1.jpeg') }}" class="absolute block w-full h-full object-contain top-0 left-0"
                    alt="...">
            </div>
            <!-- Item 2 -->
            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                <img src="{{ asset('foto2.jpeg') }}" class="absolute block w-full h-full object-contain top-0 left-0"
                    alt="...">
            </div>
        </div>
